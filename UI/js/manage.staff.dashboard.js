...
for (e of creditButtons) {
    e.addEventListener('click', () => {
        ...
        document.querySelector('.credit-debit-account-form')
            .className = 'credit-debit-account-form';
    });
}
...
const destoyCreditAccount = () => {
    document.querySelector('#credit-debit-account')
        .className = 'form to-right hide';
    destroyOverlay();
};

/* Dislaying a success message after
    submission on the reset password form */
document.querySelector('.credit-debit-account-form')
